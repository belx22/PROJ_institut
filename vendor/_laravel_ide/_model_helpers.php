...
namespace App\Models {
     ...
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property varchar|null $logo_image_extension
     * @property varchar|null $logo_image
     * @property varchar|null $flyer_image_extension
     * @property varchar|null $header_image_extension
     * @property date|null $rentree_date
     * @property varchar|null $flyer_image
     * @property string|null $promoteur_message
     * @property varchar|null $header_image
     * @property int $id
     * @method static \Illuminate\Database\Eloquent\Builder|setting whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder|setting whereHeaderImage($value)
     * @method static \Illuminate\Database\Eloquent\Builder|setting wherePromoteurMessage($value)
     * @method static \Illuminate\Database\Eloquent\Builder|setting whereFlyerImage($value)
     * @method static \Illuminate\Database\Eloquent\Builder|setting whereRentreeDate($value)
     * @method static \Illuminate\Database\Eloquent\Builder|setting whereHeaderImageExtension($value)
     * @method static \Illuminate\Database\Eloquent\Builder|setting whereFlyerImageExtension($value)
     * @method static \Illuminate\Database\Eloquent\Builder|setting whereLogoImage($value)
     * @method static \Illuminate\Database\Eloquent\Builder|setting whereLogoImageExtension($value)
